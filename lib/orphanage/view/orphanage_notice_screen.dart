...
import '../viewmodel/orphanage_notice_viewmodel.dart';
import 'package:chrip_aid/common/styles/styles.dart';

final orphanageNoticeViewModelProvider = ChangeNotifierProvider((ref) => OrphanageNoticeViewModel());

class OrphanageNoticeScreen extends ConsumerWidget {
  final VoidCallback onConfirm;

  OrphanageNoticeScreen({required this.onConfirm});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final viewModel = ref.watch(orphanageNoticeViewModelProvider);
  ...
  Widget _buildPersonalInfoCardSection(OrphanageNoticeViewModel viewModel) {
    return Card(
      color: Colors.grey[100],
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
